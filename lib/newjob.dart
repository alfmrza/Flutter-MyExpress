...
String urlUpload = "http://alifmirzaandriyanto.com/myexpress/php/upload_job.php";
...
class _CreateNewJobState extends State<CreateNewJob> {
  ...
  void _loadmap() async {
    LocationResult result = await Navigator.of(context).push(MaterialPageRoute(
        builder: (context) =>
            PlacePicker("AIzaSyBQotmapDQnEOvT9c6pkMyc4u8tbMpiUAE")));
