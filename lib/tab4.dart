...
import 'package:my_express/newjob.dart';
import 'package:my_express/payment.dart';
import 'package:my_express/registrationscreen.dart';
import 'package:my_express/splashscreen.dart';
...
String urlgetuser = "http://alifmirzaandriyanto.com/myexpress/php/get_user.php";
String urluploadImage =
    "http://alifmirzaandriyanto.com/myexpress/php/upload_imageprofile.php";
String urlupdate = "http://alifmirzaandriyanto.com/myexpress/php/update_profile.php";
File _image;
int number = 0;
String _value;
                                    ...
                                    decoration: new BoxDecoration(
                                        ...
                                        image: new DecorationImage(
                                            ...
                                            image: new NetworkImage(
                                                "http://alifmirzaandriyanto.com/myexpress/profile/${widget.user.email}.jpg?dummy=${(number)}'")))),
                              ),
                              SizedBox(height: 5),
                              Container(
                                child: Text(
      ...
      child: DropdownButton<String>(
        items: [
          DropdownMenuItem<String>(
            child: Text('100 EX-P (RM10)'),
            value: '10',
          ),
          DropdownMenuItem<String>(
            child: Text('200 EX-P (RM20)'),
            value: '20',
          ),
          DropdownMenuItem<String>(
            child: Text('300 EX-P (RM30)'),
            value: '30',
          ),
        ],
