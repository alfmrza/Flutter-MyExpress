...
class _TabScreen2State extends State<TabScreen2> {
  ...
  Future<String> makeRequest() async {
    String urlLoadJobs = "http://alifmirzaandriyanto.com/myexpress/php/load_job_user.php";
  ...
  Future<String> deleteRequest(String jobid) async {
    String urlLoadJobs = "http://alifmirzaandriyanto.com/myexpress/php/delete_job.php";
    ProgressDialog pr = new ProgressDialog(context,
        type: ProgressDialogType.Normal, isDismissible: false);
